...
export default function ProductItems() {
  ...
  let displayDetails = (pid) => {
    axios
      .get(`${baseURL}product/product-details/${pid}`)
      .then((res) => res.data)
      .then((finalRes) => {
        if (finalRes._status) {
          setproductDetails(finalRes.product);
                ...
                <div className="p-4 md:p-5 space-y-4">
                  <div className="grid grid-cols-[22%_45%_27%] gap-10">
                    <div className="border-2 rounded-md shadow-md p-4">
                      <img
                        src={staticPath+productDetails.productImage}
                        alt=""
                      />
                      Back Image
                      <img
                        src={staticPath+productDetails.productbackImage}
                        alt=""
                      />
                    </div>
                    <div className="flex items-start flex-wrap gap-5 border-2 rounded-md shadow-md p-3">
                     ...
                     productDetails.productGallery.map((v)=>
                    ...
                    <div className="border-2 rounded-md shadow-md p-3">
                      ...
                      <ul className="space-y-4 mt-8">
                        ...
                        <li className="font-semibold text-[17px]">
                          productMeterial : { productDetails.productMeterial.map( (mObj)=>mObj.materialName ).join(",")}
                          <span className="font-normal text-[16px] ">
                            &nbsp;{" "}
                          </span>{" "}
                        </li>
                        <li className="font-semibold text-[17px]">
                          Color :{ productDetails.productColor.map( (cObj)=>cObj.colorName ).join(",")}
                  ...
                  {data.map((obj, index) => {
                    return (
                      <tr className="bg-white border-b">
                        ...
                        <td className="px-6 py-4"> {obj.productName} </td>
                        <td className="px-6 py-4">
                          <div
                            dangerouslySetInnerHTML={{
                              __html: obj.productDescription,
                            }}
                          />

                          <button
                            onClick={() => displayDetails(obj._id)}
                        ...
                        <td className="px-6 py-4">
                          <img
                            ...
                            src={staticPath + obj.productImage}
                            alt=""
                          />
                        </td>
